...
public class ScreenClusterDetail extends kGuiScreenContainerLayerBase {
    ...
    public void addButtons() {
        buttons.add(new CommonTexturedButton(-1,ContainerX,ContainerY,0,0,226,146, "textures/gui/computerCluster/clusterOverview.png").setAnimatedInFBO(true).addAnime(new animeMoveLinear(-1,0,50,0)).addAnime(new animeMoveSlowIn(0, 300,-50,0,2)).addAnime(new animeFadeIn(300)));
        ...
        String str;
        stateButton = new CommonTexturedButton(10,ContainerX+24,ContainerY+18,0,146,32,32, "textures/gui/computerCluster/clusterOverview.png");
