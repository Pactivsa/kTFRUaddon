...
public class recipeMaps {
    public static final Recipe.RecipeMap
            ...
            , FuelDeburner            = new Recipe.RecipeMap(null, "ktfru.recipe.fueldeburner"           , "Fuel Deburner"             , null, 0, 1, RES_PATH_GUI + "machines/FusionTokamak",            6, 6, 0, 6, 6, 0,  1,  1, "Best: ", 1, "K", F, T, T, T, T, T, T, T)
