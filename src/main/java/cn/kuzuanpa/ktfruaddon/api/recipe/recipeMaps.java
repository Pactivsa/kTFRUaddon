...
public class recipeMaps {
    public static final Recipe.RecipeMap
            ...
            , RTG                     = new Recipe.RecipeMap(null, "ktfru.recipe.rtg"                    , "Radio Thermo Generator"    , "Radio Thermo Generator"    ,  0, 1, RES_PATH_GUI + "machines/RTG",                      1, 2, 1, 0, 0, 0,  1,  1, "", 1, "", T, T, T, T, T, F, F, F)
